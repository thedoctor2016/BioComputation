...
def selection_min(population_list):
    ...
    for i in range(POPULATION_SIZE):
        parent1 = random.randrange(POPULATION_SIZE)
        parent2 = random.randrange(POPULATION_SIZE)
...
def cross_over_min(population_list):
    ...
    for i in range(POPULATION_SIZE):
        ...
        parent1 = random.randrange(POPULATION_SIZE)
        parent2 = random.randrange(POPULATION_SIZE)
        cross_over_point = random.randrange(GENE_SIZE)
...
def main():
    population_list = populate_population_min()
    i =1
    ...
    for i in range(50):
        ...
        population_list = selection_post(population_list)
        ...
        print("Best fitness = " + str(calculate_worst_fitness(population_list)))
        mean_population=  str(calculate_mean_fitness(population_list))
        f.write(str(mean_population+'\n'))
        best_fitness = str(calculate_worst_fitness(population_list))
